...
|SwiftUICoinOrderBook| - ScrollView with targetLayout and targetBehavior <br> - visualEffect for animation <br> - GeometryProxy to obtain parent view's data <br> - ForEach Hashable & Identifiable to use in keypath id <br> - overlay to show additional view within view (return as one view with overlay view) <br> - StateObject vs. ObservedObject: difference when body renders <br> - Network api call not in onAppear (everytime new body draw, network call occurs) <br> - NameSpace for grouping different views as same one (apply same animation) <br> - withAnimation with various modifiers to apply animation, using State variable to choose whether apply it or not |
